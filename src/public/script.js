...
const copyBookmarkUrl = () => {
    const [, , bookmarkUrl] = editingMemo;
    navigator.clipboard.writeText(bookmarkUrl);
    showMessagePopup('Url copied.', 'info');
};
...
const importData = files => {
    ...
    reader.onload = async event => {
        try {
            const appName = homeTabData.app_name;
            const version = homeTabData.version;
...
const renderHTMLElements = () => {
    // copy bookmark url
    html('.copy-url-button', svgSource.copy);
    qs('.copy-url-button').addEventListener('click', copyBookmarkUrl);
...
const svgSource = {
    ...
    copy: '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 37.5 37.5" preserveAspectRatio="xMidYMid meet" version="1.0"><defs><clipPath id="f9b76097f2"><path d="M 12.730469 1.777344 L 32.5625 1.777344 C 32.957031 1.777344 33.332031 1.933594 33.609375 2.210938 C 33.886719 2.488281 34.042969 2.863281 34.042969 3.257812 L 34.042969 31.082031 C 34.042969 31.472656 33.886719 31.851562 33.609375 32.128906 C 33.332031 32.40625 32.957031 32.5625 32.5625 32.5625 L 12.730469 32.5625 C 12.339844 32.5625 11.960938 32.40625 11.683594 32.128906 C 11.40625 31.851562 11.25 31.472656 11.25 31.082031 L 11.25 3.257812 C 11.25 2.863281 11.40625 2.488281 11.683594 2.210938 C 11.960938 1.933594 12.339844 1.777344 12.730469 1.777344 Z M 12.730469 1.777344 " clip-rule="nonzero"/></clipPath><clipPath id="3c8e2c044a"><path d="M 5.179688 5.476562 L 25.015625 5.476562 C 25.40625 5.476562 25.78125 5.632812 26.058594 5.910156 C 26.339844 6.1875 26.492188 6.566406 26.492188 6.957031 L 26.492188 34.78125 C 26.492188 35.175781 26.339844 35.550781 26.058594 35.828125 C 25.78125 36.105469 25.40625 36.261719 25.015625 36.261719 L 5.179688 36.261719 C 4.789062 36.261719 4.414062 36.105469 4.132812 35.828125 C 3.855469 35.550781 3.703125 35.175781 3.703125 34.78125 L 3.703125 6.957031 C 3.703125 6.566406 3.855469 6.1875 4.132812 5.910156 C 4.414062 5.632812 4.789062 5.476562 5.179688 5.476562 Z M 5.179688 5.476562 " clip-rule="nonzero"/></clipPath></defs><g clip-path="url(#f9b76097f2)"><path class="copy-button-theme" stroke-linecap="butt" transform="matrix(0.740132, 0, 0, 0.740132, 11.250556, 1.776316)" fill="#ffffff" stroke-linejoin="miter" d="M 1.999526 0.00138889 L 28.794806 0.00138889 C 29.327861 0.00138889 29.834528 0.2125 30.20925 0.587222 C 30.583973 0.961945 30.795084 1.468611 30.795084 2.001667 L 30.795084 39.59528 C 30.795084 40.123058 30.583973 40.635003 30.20925 41.009725 C 29.834528 41.384447 29.327861 41.595558 28.794806 41.595558 L 1.999526 41.595558 C 1.471748 41.595558 0.959804 41.384447 0.585082 41.009725 C 0.210359 40.635003 -0.000751637 40.123058 -0.000751637 39.59528 L -0.000751637 2.001667 C -0.000751637 1.468611 0.210359 0.961945 0.585082 0.587222 C 0.959804 0.2125 1.471748 0.00138889 1.999526 0.00138889 Z M 1.999526 0.00138889 " stroke="#000000" stroke-width="4" stroke-opacity="1" stroke-miterlimit="4"/></g><g clip-path="url(#3c8e2c044a)"><path class="copy-button-theme" stroke-linecap="butt" transform="matrix(0.740132, 0, 0, 0.740132, 3.701214, 5.476973)" fill="#ffffff" stroke-linejoin="miter" d="M 1.997582 -0.00055505 L 28.798139 -0.00055505 C 29.325917 -0.00055505 29.832584 0.210556 30.207306 0.585278 C 30.587306 0.960001 30.793139 1.471945 30.793139 1.999723 L 30.793139 39.593337 C 30.793139 40.126392 30.587306 40.633059 30.207306 41.007781 C 29.832584 41.382503 29.325917 41.593614 28.798139 41.593614 L 1.997582 41.593614 C 1.469804 41.593614 0.963137 41.382503 0.583137 41.007781 C 0.208415 40.633059 0.00258167 40.126392 0.00258167 39.593337 L 0.00258167 1.999723 C 0.00258167 1.471945 0.208415 0.960001 0.583137 0.585278 C 0.963137 0.210556 1.469804 -0.00055505 1.997582 -0.00055505 Z M 1.997582 -0.00055505 " stroke="#000000" stroke-width="4" stroke-opacity="1" stroke-miterlimit="4"/></g></svg>'
};
